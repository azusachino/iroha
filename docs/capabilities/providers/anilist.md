...
AniList state must not overwrite Iroha event history. A later sync may append a new observation or event and must retain the original provider snapshot.
