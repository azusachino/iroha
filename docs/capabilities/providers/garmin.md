...
Garmin must add provider observations, not a second canonical activity or sleep
model. Candidate evidence includes FIT, TCX, CSV/JSON exports, and future
connector snapshots; the exact intake formats are implementation decisions.
