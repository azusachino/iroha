# Design lab v1 — Today directions
...
The useful conclusion is a hybrid: use the showcase / editorial opening for orientation, the command-center instruments for scanning, and the chronicle pattern for explaining a day in sequence. Keep
domain pages focused on one job instead of repeating every treatment everywhere.
