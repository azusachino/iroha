...
| Route compositions                                                        | [`apps/iroha-web/src/lib/themes/`](../apps/iroha-web/src/lib/themes/)                                                                                                                              | Partially wrong. 24 route components remain app-local (4 per registered language); Daily, Media, Expenses, Activities, Activity Detail, Reports, Sleep, and Media Detail are now package-owned. |
...
The route folders now contain 24 Svelte files, 4 per registered production language. Daily, Media, Expenses, Activities, Activity Detail, Reports, Sleep, and Media Detail have moved to
...
4. **Complete:** move the Daily, Media, Expenses, Activities, Activity Detail, Reports, Sleep, and Media Detail route families across the registered languages, including shared primitives, registry
   entries, and design-page specimens.
