...
| Page differentiation       | Today, Overview, Patterns, and the design lab all use variations of tile/bento/dashboard compositions.                                                                                                      | PARTIAL           | The application can feel like one repeated dashboard even when the information purpose changes.                                                | Assign distinct archetypes: command center, observatory, atlas, archive, report, library, and editorial share page.                             |
