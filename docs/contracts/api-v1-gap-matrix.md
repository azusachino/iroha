...
| Release stability         | CANDIDATE       | v0.4.1 cache/report implementation passes `make check`; `make validate`, the release-candidate gate, public-site checks/build, and the local k3s rollout are the remaining evidence. |
