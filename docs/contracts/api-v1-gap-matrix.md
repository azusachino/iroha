...
Status: v0.4.0 release-candidate contract inventory
...
| Release stability         | CANDIDATE       | v0.4.0 passes `make check`, `make validate`, the release-candidate gate, public-site checks/build, and the documented dev k3s rollout; Gate C remains owner approval. |
...
3. Rehearse the real upload-to-worker workflow before each production release; the v0.4 release-candidate rehearsal is recorded, not a permanent compatibility guarantee.
4. Complete the owner Gate C review before merging/tagging v0.4.0.
