...
func TestParseSnapshotMapsAnimeAndBookCollection(t *testing.T) {
  ...
  "total": 2, "data": [
    {"subject_type": 2, "type": 3, "rate": 8, "comment": "good", "tags": ["favorite"], "ep_status": 9, "updated_at": "2026-07-13T10:00:00+00:00", "subject": {"id": 20, "name": "NARUTO", "name_cn": "火影忍者", "date": "2002-10-03", "eps": 220}},
