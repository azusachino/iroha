...
func DefaultRegistry() (*Registry, error) {
	return NewRegistry([]Definition{
		...
		{ID: "sleep.asleep_s", Domain: "sleep", Label: "Asleep time", Description: "Average asleep duration by sleep kind.", Kind: "derived", ValueType: "duration", Unit: "s", ShortUnit: "s", SupportedGrains: []string{"month"}, Dimensions: []Dimension{{ID: "sleep_kind", Label: "Sleep kind", Values: []string{"main", "nap"}, ExpandByDefault: true}}, Reducer: "average_asleep", Rollup: "average", AggregationVersion: "sleep.average_asleep.v1", CoverageKind: "observed_periods", SemanticColorToken: "sleep", PreferredView: "line"},
		{ID: "sleep.efficiency", Domain: "sleep", Label: "Sleep efficiency", Description: "Average main-sleep efficiency.", Kind: "derived", ValueType: "percentage", Unit: "%", ShortUnit: "%", SupportedGrains: []string{"month"}, Dimensions: []Dimension{{ID: "sleep_kind", Label: "Sleep kind", Values: []string{"main"}, ExpandByDefault: true}}, Reducer: "average_efficiency", Rollup: "average", AggregationVersion: "sleep.average_efficiency.v1", CoverageKind: "observed_periods", SemanticColorToken: "sleep", PreferredView: "line"},
	})
}
