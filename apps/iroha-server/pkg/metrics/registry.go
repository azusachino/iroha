...
func DefaultRegistry() (*Registry, error) {
	return NewRegistry([]Definition{
		...
		{ID: "movement.activity_count", Domain: "movement", Label: "Activities", Description: "Count of canonical activity sessions.", Kind: "derived", ValueType: "count", Unit: "count", ShortUnit: "activities", SupportedGrains: []string{"month"}, Dimensions: []Dimension{{ID: "sport", Label: "Sport", Values: []string{"hike", "ride", "run", "swim", "walk", "other"}}}, Reducer: "count_activity", Rollup: "count", AggregationVersion: "movement.count_activity.v1", CoverageKind: "observed_periods", SemanticColorToken: "movement", PreferredView: "bar"},
		{ID: "movement.distance_m", Domain: "movement", Label: "Distance", Description: "Sum of non-null canonical activity distances.", Kind: "derived", ValueType: "number", Unit: "m", ShortUnit: "m", SupportedGrains: []string{"month"}, Dimensions: []Dimension{{ID: "sport", Label: "Sport", Values: []string{"hike", "ride", "run", "swim", "walk", "other"}}}, Reducer: "sum_distance", Rollup: "sum", AggregationVersion: "movement.sum_distance.v1", CoverageKind: "observed_periods", SemanticColorToken: "movement", PreferredView: "bar"},
		{ID: "movement.duration_s", Domain: "movement", Label: "Duration", Description: "Sum of non-null canonical activity durations.", Kind: "derived", ValueType: "duration", Unit: "s", ShortUnit: "s", SupportedGrains: []string{"month"}, Dimensions: []Dimension{{ID: "sport", Label: "Sport", Values: []string{"hike", "ride", "run", "swim", "walk", "other"}}}, Reducer: "sum_duration", Rollup: "sum", AggregationVersion: "movement.sum_duration.v1", CoverageKind: "observed_periods", SemanticColorToken: "movement", PreferredView: "bar"},
