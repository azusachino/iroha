...
func DefaultRegistry() (*Registry, error) {
	return NewRegistry([]Definition{
		...
		{ID: "media.completed_count", Domain: "media", Label: "Completed media", Description: "Count of completed media events.", Kind: "derived", ValueType: "count", Unit: "count", ShortUnit: "items", SupportedGrains: []string{"month"}, Dimensions: []Dimension{{ID: "media_kind", Label: "Media kind", Values: []string{"anime", "book", "game", "manga"}}}, Reducer: "count_completed", Rollup: "count", AggregationVersion: "media.count_completed.v1", CoverageKind: "observed_periods", SemanticColorToken: "media", PreferredView: "bar"},
		{ID: "movement.activity_count", Domain: "movement", Label: "Activities", Description: "Count of canonical activity sessions.", Kind: "derived", ValueType: "count", Unit: "count", ShortUnit: "activities", SupportedGrains: []string{"month"}, Dimensions: []Dimension{{ID: "sport", Label: "Sport", Values: []string{"cycling", "hiking", "running", "swimming", "walking", "other"}}}, Reducer: "count_activity", Rollup: "count", AggregationVersion: "movement.count_activity.v1", CoverageKind: "observed_periods", SemanticColorToken: "movement", PreferredView: "bar"},
		{ID: "movement.distance_m", Domain: "movement", Label: "Distance", Description: "Sum of non-null canonical activity distances.", Kind: "derived", ValueType: "number", Unit: "m", ShortUnit: "m", SupportedGrains: []string{"month"}, Dimensions: []Dimension{{ID: "sport", Label: "Sport", Values: []string{"cycling", "hiking", "running", "swimming", "walking", "other"}}}, Reducer: "sum_distance", Rollup: "sum", AggregationVersion: "movement.sum_distance.v1", CoverageKind: "observed_periods", SemanticColorToken: "movement", PreferredView: "bar"},
		{ID: "movement.duration_s", Domain: "movement", Label: "Duration", Description: "Sum of non-null canonical activity durations.", Kind: "derived", ValueType: "duration", Unit: "s", ShortUnit: "s", SupportedGrains: []string{"month"}, Dimensions: []Dimension{{ID: "sport", Label: "Sport", Values: []string{"cycling", "hiking", "running", "swimming", "walking", "other"}}}, Reducer: "sum_duration", Rollup: "sum", AggregationVersion: "movement.sum_duration.v1", CoverageKind: "observed_periods", SemanticColorToken: "movement", PreferredView: "bar"},
		{ID: "sleep.asleep_s", Domain: "sleep", Label: "Asleep time", Description: "Average main-sleep duration.", Kind: "derived", ValueType: "duration", Unit: "s", ShortUnit: "s", SupportedGrains: []string{"month"}, Dimensions: []Dimension{{ID: "sleep_kind", Label: "Sleep kind", Values: []string{"main", "nap"}}}, Reducer: "average_asleep", Rollup: "average", AggregationVersion: "sleep.average_asleep.v1", CoverageKind: "observed_periods", SemanticColorToken: "sleep", PreferredView: "line"},
		{ID: "sleep.efficiency", Domain: "sleep", Label: "Sleep efficiency", Description: "Average main-sleep efficiency.", Kind: "derived", ValueType: "percentage", Unit: "%", ShortUnit: "%", SupportedGrains: []string{"month"}, Dimensions: []Dimension{{ID: "sleep_kind", Label: "Sleep kind", Values: []string{"main"}}}, Reducer: "average_efficiency", Rollup: "average", AggregationVersion: "sleep.average_efficiency.v1", CoverageKind: "observed_periods", SemanticColorToken: "sleep", PreferredView: "line"},
	})
}
