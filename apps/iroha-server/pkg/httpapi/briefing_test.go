...
func TestHandleBriefingReturnsVersionedSections(t *testing.T) {
	...
	want := `{"date":"2026-07-14","previous_date":"2026-07-13","next_date":"2026-07-15","sections":[{"key":"daily","schema":"daily.day.v1","state":"ready","status":{"availability":"supported","collection":"unknown","operation":"idle","freshness":"unknown"},"data":{"steps":3}}]}` + "\n"
